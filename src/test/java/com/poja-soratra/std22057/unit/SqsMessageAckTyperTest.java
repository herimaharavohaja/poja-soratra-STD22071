package com.poja-soratra.std22057.unit;
...
import com.poja-soratra.std22057.endpoint.event.EventConsumer;
...
public class SqsMessageAckTyperTest extends FacadeIT {
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent =
        new EventConsumer.TypedEvent("com.poja-soratra.std22057.endpoint.event.gen.UuidCreated", payload);
